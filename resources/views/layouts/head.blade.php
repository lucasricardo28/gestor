<head>
    ...
    <!-- Theme style -->
    <link rel="stylesheet" href="{{ asset('admin_layout/dist/css/style.css') }}">
    ...
    {{--Themefy icons--}}
    <link rel="stylesheet" href="{{ asset('admin_layout/dist/css/et-line-font/et-line-font.css') }}">
    <link rel="stylesheet" href="{{ asset('admin_layout/dist/css/themify-icons/themify-icons.css') }}">

    {{-- Simple Icons--}}
    <link rel="stylesheet" href="{{ asset('admin_layout/dist/css/simple-lineicon/simple-line-icons.css') }}">
