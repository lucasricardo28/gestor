...
class CommunitiesController extends Controller
{
    ...
    public function index()
    {
        ...
        $regionals = Regional::all()->pluck('name','id');
        ...
        return view('communities.index', compact('communities','regionals'));
    }
    ...
    public function store(CommunityCreateRequest $request)
    {
        try {
            ...
            $community = $this->repository->create($request->all());
    ...
    public function edit($id)
    {
        ...
        return view('communities.edit', compact('community','regionals'));
    }
    ...
    public function update(CommunityUpdateRequest $request, $id)
    {
        try {
            ...
            $community = $this->repository->update($request->all(), $id);
            ...
            return redirect()->route('communities.index')->with('message', $response['message']);
